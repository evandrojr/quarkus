 ...
 * of any IdentifierGenerator which is generated during the build of the Metadata.
 ...
 * will look them up by either fully qualified name or strategy name.
 * We should be able to trust that no Class is going to be needed, unless it was actually
 * used during the build of the Metadata.
 */
